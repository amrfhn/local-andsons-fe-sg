...
export default {
  ...
  render() {
    ...
    //       ({ key }) => key === this.subscription.status
    //     );
    //     return index === -1
    //       ? []
    ...
    return (
      <div class="subscription-status-content">
        {this.subscription.subscription_status.statuses.map((status, index) => (
          <div
            class={classnames("subscription-status-item", {
              active: this.subscription.subscription_status.subscription_pos >= index,
            })}
          >
            <div class="icon">
              <img src={imageArr[index]} alt="subscription status icon" />
            </div>
