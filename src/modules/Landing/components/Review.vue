<template>
  <section id="review-section" class="tw-hidden">
    <h3 class="tw-text-4xl md:tw-text-6xl tw-font-black tw-text-center tw-mb-3">
      It's about you
    </h3>
    <p class="tw-text-center md:tw-text-2xl tw-text-lg tw-w-4/5 tw-m-auto md:tw-mb-12 tw-mb-6">
...
.ReviewsGrid__Item .ReviewsCard .ReviewsCard__Comments {
  font-size: 16px !important;
  line-height: 1.4;
}
#ReviewsLoadingSpinner span {
